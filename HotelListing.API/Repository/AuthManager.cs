...
namespace HotelListing.API.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<IEnumerable<IdentityError>> Register(UserDto userDto, bool createAsAdminUser = false)
        {
        ...
        {
            var jwtSecurityTokneHandler = new JwtSecurityTokenHandler();
            var tokenContent = jwtSecurityTokneHandler.ReadJwtToken(request.Token);
            ...
            // Invalidate token for the current user
